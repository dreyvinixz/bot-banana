...
const config = {
  ...
  WELCOME_PRINCIPAL_CHANNEL_ID: getEnvString("WELCOME_PRINCIPAL_CHANNEL_ID", "1528288031101026405"),
  ANUNCIO_CARGOS_CHANNEL_ID: getEnvString("ANUNCIO_CARGOS_CHANNEL_ID", "1528288031101026405"),
  WELCOME_GUIA_CHANNEL_ID: getEnvString("WELCOME_GUIA_CHANNEL_ID", "1530089852106834091"),
  IDEIAS_CHANNEL_ID: getEnvString("IDEIAS_CHANNEL_ID", "1530085098047930600"),
  FOTOS_CHANNEL_ID: getEnvString("FOTOS_CHANNEL_ID", "1528288033986842725"),
  MEMES_CHANNEL_ID: getEnvString("MEMES_CHANNEL_ID", "1529494487729176798"),
  COMANDOS_CHANNEL_ID: getEnvString("COMANDOS_CHANNEL_ID", "1529496411446444202"),
  ENABLE_GUILD_MEMBERS_INTENT: getEnvBoolean("ENABLE_GUILD_MEMBERS_INTENT", true),
